...
--
-- Hôte : localhost:8889
-- Généré le : mer. 10 nov. 2021 à 19:09
...
ALTER TABLE `listes`
  ...
  ADD KEY `couleur_id_2` (`couleur_id`),
...
--
ALTER TABLE `items`
  ADD CONSTRAINT `items_ibfk_1` FOREIGN KEY (`liste_id`) REFERENCES `listes` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `listes`
--
ALTER TABLE `listes`
  ADD CONSTRAINT `listes_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `listes_ibfk_2` FOREIGN KEY (`couleur_id`) REFERENCES `couleurs` (`id`) ON DELETE NO ACTION;
COMMIT;
